...
const testimonials = [
  {
    quote:
      "AIR's dedication to bringing an innovative and forward-thinking approach made them the ideal partner for our brand.",
    name: 'Frill Lee',
  ...
  {
    quote:
      "AIR's understanding of our key goals and execution allowed us to reach milestones we never expected.",
    name: 'Scott Masters',
  ...
  {
    quote:
      'AIR were able to create a unique experience that brought our company brand vision together with modern strategy.',
    name: 'Mia Farrow',
    role: 'CMO',
    image: testimonial3,
  },
...
const Testimonials = () => (
  <section id="testimonials" className="section section--surface testimonials">
